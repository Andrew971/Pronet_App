        ...
        <ListItem button onClick={this.handleClick}>
          ...
          <Collapse in={this.state.open} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem button className={classes.nested} onClick={()=>{toggleDrawer('right', false); history.push(`${match.url}${Paths.website}`)}}>
                <ListItemIcon>
                  <StarBorder />
                </ListItemIcon>
                <ListItemText inset primary="Général" />
              </ListItem>
              <ListItem button className={classes.nested} onClick={()=>{toggleDrawer('right', false);
                 history.push(`${match.url}${Paths.WebContent}`)
               }}>
                <ListItemIcon>
                  <StarBorder />
                </ListItemIcon>
...
export default withRouter(withStyles(styles)(UserNav));
