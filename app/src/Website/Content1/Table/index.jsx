...
class TableContent extends React.Component {
  ...
  render() {
    const {handleClick, onSelectAllClick, numSelected, data, rowCount} = this.props
    ...
    return (<Fragment>
      ...
      <TablePagination component="div" count={data.length} rowsPerPage={1} page={5} backIconButtonProps={{
          'aria-label' : 'Previous Page'
        }} nextIconButtonProps={{
          'aria-label' : 'Next Page'
        }} onChangePage={() => 0} onChangeRowsPerPage={() => 0}/>
    </Fragment>);
  }
}
